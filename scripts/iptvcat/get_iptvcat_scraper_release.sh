...
for param in ${release_name_list[@]}; do
    ...
    # url=https://github.com/Navezjt/iptvcat-scraper/releases/download/${param}/streams.zip
    url=https://github.com/Navezjt/ez-iptvcat-scraper/releases/download/${param}/streams.zip
